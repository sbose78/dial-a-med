...
<link rel="stylesheet" href="<%=request.getContextPath()%>/colorbox/colorbox.css" />
...
<script>
	...
	{
        $(".discuss").colorbox({iframe:true, innerWidth:425, innerHeight:344});    	//	alert("here");
...
<div id="table_container"><a>
	...
	<table>
		<th width="20%">User</th> <th width="20%">Audio</th> <th width="20%">Solution</th> <th width="20%">Update solution</th>
...
%>		
		...
		<tr>
		<td align="center"> 
		 <a class="userinfo" href="<%=request.getContextPath() %>/showUserInfo.jsp?mobile=<%=h.getMobile()%>">User info</a>
...
<% 
		...
		<td align="center"><a class="discuss"  href="<%=request.getContextPath()%>/postSolution.jsp?health_issue_id=<%=h.getHealth_issue_id() %>">SUBMIT SOLUTION</a></td>
		</tr>
	<% } %>
	</table>
