...
public class DbCon {
    ...
    public static Connection getDbConnection()
    {
        ...
        */
                ...
                String url = "jdbc:mysql://"+ properties.getProperty("database_host_bose")+":"+properties.getProperty("database_port_bose")+"/";
                String dbName = properties.getProperty("database_database_bose");
                String driver = "com.mysql.jdbc.Driver";
                String userName = properties.getProperty("database_user_bose");
                String password = properties.getProperty("database_password_bose");
